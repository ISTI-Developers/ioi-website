...
function Slide({ slide, scrollPrev, scrollNext }: {
  slide: typeof slides[0];  // ← semicolon here was missing
  scrollPrev: () => void;
  scrollNext: () => void;
}) {
  ...
  return (
    <div className="relative flex-[0_0_100%] min-w-0 lg:px-6 grid grid-cols-1 md:grid-cols-12 gap-10 items-stretch">
